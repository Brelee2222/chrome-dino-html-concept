...
var sprt = {
  ...
  "Death":"/chrome-dino-html-concept/dinodeath.png"
};
var death = false
var sided = true
var dnh = 0
...
function dnanimation() {
 if (sided) {
   document.getElementById('dn').style.background = 'url(/chrome-dino-html-concept/dinosprts.png)';
    document.getElementById('dn').style.backgroundPosition = '587px 0px';
 } else {
   document.getElementById('dn').style.background = 'url(/chrome-dino-html-concept/dinosprts.png)';
    document.getElementById('dn').style.backgroundPosition = '499px 0px';
 };
 if (dnh > 1) {
    document.getElementById('dn').style.background = 'url(/chrome-dino-html-concept/dinosprts.png)';
    document.getElementById('dn').style.backgroundPosition = '763px 0px';
 };
 if (death) {
   document.getElementById('dn').style.background = 'url(/chrome-dino-html-concept/dinosprts.png)';
    document.getElementById('dn').style.backgroundPosition = '411px 0px';
   setTimeout(crashclose,3000)
 };
...
document.getElementById('dn').style.width = '88px';
document.getElementById('dn').style.height = '97px';
speeds();
dnanimation();
move();
spawn();
